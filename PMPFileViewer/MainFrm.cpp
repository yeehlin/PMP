...
void CMainFrame::OnMainfrmSpinodaldecompositionCalculate()
{
	...
	this->m_wndFileView.FillFileViewByModuleType(1);
	this->m_wndFileView.getFileTreeView()->setModuleType(1);
...
{
	// TODO: Add your command handler code here
	this->m_wndFileView.FillFileViewByModuleType(2);
	this->m_wndFileView.getFileTreeView()->setModuleType(2);
}
