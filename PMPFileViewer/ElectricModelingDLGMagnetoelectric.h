...
class ElectricModelingDLGMagnetoelectric : public CDialog
{
	DECLARE_DYNAMIC(ElectricModelingDLGMagnetoelectric)

public:
	ElectricModelingDLGMagnetoelectric(CWnd* pParent = NULL);   // standard constructor
	virtual ~ElectricModelingDLGMagnetoelectric();

// Dialog Data
	enum { IDD = IDD_MODELING_DLG_MAGNETOELECTRIC };
