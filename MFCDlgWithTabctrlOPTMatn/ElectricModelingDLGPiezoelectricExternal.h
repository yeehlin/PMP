...
class ElectricModelingDLGPiezoelectricExternal : public CDialog
{
	DECLARE_DYNAMIC(ElectricModelingDLGPiezoelectricExternal)

public:
	ElectricModelingDLGPiezoelectricExternal(CWnd* pParent = NULL);   // standard constructor
	virtual ~ElectricModelingDLGPiezoelectricExternal();

// Dialog Data
	enum { IDD = IDD_MODELING_DLG_PEIZOELECTRIC_EXTERNAL };
