	...
	case 0:
		{
			...
			case 0:
				break;
			case 1:
				if (m_pelectricModelingDLGMoreElastic->m_pelectricModelingDLGMechanical == NULL)
				{
					m_pelectricModelingDLGMoreElastic->m_pelectricModelingDLGMechanical = new ElectricModelingDLGMechanical();
				}
				break;
			}
			break;
	...
	case 1:
		{
			...
			case 0:
				break;
			case 1:
				if (m_pelectricModelingDLGMoreDielectric->m_pelectricModelingDLGExternal == NULL)
				{
					m_pelectricModelingDLGMoreDielectric->m_pelectricModelingDLGExternal = new ElectricModelingDLGExternal();
				}
				break;
			}
			break;
	...
	case 2:
		{
			...
			case 0:
				break;
			case 1:
				if (m_pelectricModelingDLGMorePiezoelectric->m_pelectricModelingDLGChild3 == NULL)
				{
					m_pelectricModelingDLGMorePiezoelectric->m_pelectricModelingDLGChild3 = new ElectricModelingDLGChild3();
				}
				break;
			}
			break;
