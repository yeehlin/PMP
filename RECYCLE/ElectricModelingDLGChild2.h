...
class ElectricModelingDLGChild2 : public CDialog
{
	DECLARE_DYNAMIC(ElectricModelingDLGChild2)

public:
	ElectricModelingDLGChild2(CWnd* pParent = NULL);   // standard constructor
	virtual ~ElectricModelingDLGChild2();

// Dialog Data
	enum { IDD = IDD_MODELING_DLG_CHILD2 };
