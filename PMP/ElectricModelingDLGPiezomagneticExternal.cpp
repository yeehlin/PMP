// ElectricModelingDLGPiezomagneticExternal.cpp : implementation file
//
...
// ElectricModelingDLGPiezomagneticExternal dialog

IMPLEMENT_DYNAMIC(ElectricModelingDLGPiezomagneticExternal, CDialog)

ElectricModelingDLGPiezomagneticExternal::ElectricModelingDLGPiezomagneticExternal(CWnd* pParent /*=NULL*/)
	: CDialog(ElectricModelingDLGPiezomagneticExternal::IDD, pParent)
{
...
ElectricModelingDLGPiezomagneticExternal::~ElectricModelingDLGPiezomagneticExternal()
{
}

void ElectricModelingDLGPiezomagneticExternal::DoDataExchange(CDataExchange* pDX)
{
	...
	// 在对应资源中没有这个ID号的控件，却要为这个不存在的控件关联一个值：出错
...
BEGIN_MESSAGE_MAP(ElectricModelingDLGPiezomagneticExternal, CDialog)
	ON_BN_CLICKED(IDOK, &ElectricModelingDLGPiezomagneticExternal::OnBnClickedOk)
	ON_CBN_SELCHANGE(IDC_COMBO_MECHANICAL_BOUNDARY, &ElectricModelingDLGPiezomagneticExternal::OnCbnSelchangeComboMechanicalBoundary)
END_MESSAGE_MAP()


// ElectricModelingDLGPiezomagneticExternal message handlers


void ElectricModelingDLGPiezomagneticExternal::OnBnClickedOk()
{
...
BOOL ElectricModelingDLGPiezomagneticExternal::OnInitDialog()
{
...
void ElectricModelingDLGPiezomagneticExternal::OnCbnSelchangeComboMechanicalBoundary()
{
	// TODO: Add your control notification handler code here
