...
class ElectricModelingDLGPiezomagneticExternal : public CDialog
{
	DECLARE_DYNAMIC(ElectricModelingDLGPiezomagneticExternal)

public:
	ElectricModelingDLGPiezomagneticExternal(CWnd* pParent = NULL);   // standard constructor
	virtual ~ElectricModelingDLGPiezomagneticExternal();

// Dialog Data
	enum { IDD = IDD_MODELING_DLG_PEIZOMAGNETIC_EXTERNAL };
