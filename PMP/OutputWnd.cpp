...
void COutputWnd::FillBuildWindowByString(CString output){
	m_wndOutputBuild.AddString(output);
}
void COutputWnd::FillBuildWindowByStringArray(CStringArray & list){
	for(int i=0;i<list.GetSize();i++){
		m_wndOutputBuild.AddString(list.GetAt(i));
	}
}
